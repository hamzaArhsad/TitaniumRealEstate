...
namespace Titanium_MVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly Microsoft.AspNetCore.Identity.UI.Services.IEmailSender _emailSender; // Fully qualified
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // Assign roles based on whether it's the first user
                    ...
                    {
                        Claim userClaim = new Claim(ClaimTypes.Role, "User");
